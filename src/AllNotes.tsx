...
export function AllNotes({ availableTags, notes, onUpdateTag, onDeleteTag }: NoteListProps) {
        ...
        <Row className="mb-5">
            ...
            <Col xs="auto">
                <Stack gap={2} direction="horizontal">
                    ...
                    <Button onClick={() => setEditTagsModalIsOpen(true)} variant="secondary">My Tags</Button> 
                </Stack>
            </Col>
        </Row>
        <Form className="mb-5">
